...
from Market_Class_0620 import Market,Read_Future_Data, Merge
...
future_dir = "Future0614_cost_demand_Uncertainty"  # the future results directory name
...
S = 3  # number of simulation runs for uncertainty analysis
